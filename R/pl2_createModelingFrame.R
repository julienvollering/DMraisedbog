...
# Clean up mask objects
rm(mask_artype60, mask_presence, mask)
gc()
...
rm(raster_current, presence, absence, df_presence, df_absence)
gc()
...
# Clean up future raster and memory after large conversion
rm(raster_future)
gc()
